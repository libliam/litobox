...
export const TOOL_LIST: ToolItem[] = [
  ...
  { id: 'encode', name: '编码转换', icon: 'En', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7V4h16v3"/><path d="M9 20h6"/><path d="M12 4v16"/><path d="M16 16l-2-4-2 4"/></svg>`, description: 'URL、Base64、HTML实体、Unicode 编解码，时间戳转换', keywords: ['编码', 'base64', 'url', 'unicode', 'html实体', '时间戳'], category: 'dev' },
  { id: 'hash', name: '加密解密', icon: '#', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 9h16M4 15h16"/><path d="M10 3l-2 18M16 3l-2 18"/></svg>`, description: 'MD5/SHA 哈希、AES/DES 加密解密、HMAC', keywords: ['hash', 'md5', 'sha', '哈希', '加密', '解密', 'aes', 'des', 'hmac'], category: 'dev' },
  ...
  { id: 'image', name: '图片工具', icon: '', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`, description: '批量压缩/格式转换、尺寸缩放、图片转Base64、加水印、拼图、调色板提取', keywords: ['图片', '压缩', '缩放', 'base64', '拼接', '水印', '调色板', '格式转换', 'image'], category: 'utility' },
