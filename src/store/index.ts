...
export const TOOL_LIST: ToolItem[] = [
  ...
  { id: 'jsonDiff', name: 'JSON 结构化对比', icon: 'JS≠', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4H6a2 2 0 0 0-2 2v2a2 2 0 0 1-2 2 2 2 0 0 1 2 2v2a2 2 0 0 0 2 2h2"/><path d="M16 4h2a2 2 0 0 1 2 2v2a2 2 0 0 0 2 2 2 2 0 0 0-2 2v2a2 2 0 0 1-2 2h-2"/><path d="M12 7v10"/><path d="M9.5 10.5 12 13l2.5-2.5"/></svg>`, description: '结构化对比两个 JSON：忽略键顺序、数组按索引逐项比较，差异列表含路径/两侧值可复制', keywords: ['json', '对比', 'diff', '结构化', '接口', '配置', '数据对比', '差异'], category: 'text' },
  ...
  { id: 'nameCase', name: '变量命名转换', icon: 'aA', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" font-family="'Segoe UI', Consolas, monospace" font-size="13" font-weight="700"><text x="1.5" y="13">a</text><text x="9" y="20">A</text></svg>`, description: 'camelCase/PascalCase/snake_case/SCREAMING_SNAKE/kebab-case/dot.case/Title Case 七风格互转，支持缩写词识别与批量逐行', keywords: ['命名', '变量', '转换', '驼峰', 'camel', 'pascal', 'snake', '下划线', 'kebab', 'constant', '常量', '小驼峰', '大驼峰', '批量', '改名'], category: 'text' },
  { id: 'tcConvert', name: '中文繁简转换', icon: '简繁', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" font-family="'Microsoft YaHei', 'Segoe UI', sans-serif" font-size="9" font-weight="700"><text x="1" y="13">简</text><text x="12" y="13">繁</text></svg>`, description: '中文简体/繁体互转：OpenCC 词组级转换（头发→頭髮、发生→發生 不误转），自动检测文本方向，整段批量转换', keywords: ['繁简', '简繁', '简体', '繁体', '繁体字', '转换', '转简体', '转繁体', '汉字', '中文', 't2s', 's2t', 'opencc'], category: 'text' },
  ...
  { id: 'wsClient', name: 'WebSocket', icon: 'WS', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4c2 4 2 12 0 16"/><path d="M10 4c3 5 3 11 0 16"/><path d="M16 4c2 4 2 12 0 16"/><path d="M22 4c2 4 2 12 0 16"/></svg>`, description: 'WebSocket 客户端：连接/断开/收发消息、子协议、自动重连、消息日志', keywords: ['websocket', 'ws', 'wss', 'socket', '实时通信', '连接', '消息'], category: 'dev' },
  ...
  { id: 'ollama', name: 'LLM管理', icon: '🧠', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a4 4 0 0 0-4 4v1a3 3 0 0 0-3 3 3 3 0 0 0-1 5.83V17a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-1.17A3 3 0 0 0 19 10a3 3 0 0 0-3-3V6a4 4 0 0 0-4-4z"/><path d="M12 2v20"/><path d="M8 8h.01M16 8h.01"/></svg>`, description: '本地大模型（Ollama）管理：模型下载/删除、运行监控、显存释放、对话测试', keywords: ['ollama', '大模型', 'llm', 'ai', '模型管理', '本地模型', '对话', 'llama'], category: 'dev' },
  { id: 'chmod', name: 'Chmod计算器', icon: 'rwx', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="9" y1="4" x2="9" y2="20"/><line x1="15" y1="4" x2="15" y2="20"/></svg>`, description: 'Linux/Unix 文件权限可视化计算，R/W/X 勾选与数字/符号权限实时互转', keywords: ['chmod', '权限', 'linux', 'unix', 'rwx', '权限计算', '文件权限'], category: 'dev' },
  { id: 'cheatSheet', name: '速查表', icon: '📖', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/><line x1="8" y1="7" x2="16" y2="7"/><line x1="8" y1="11" x2="14" y2="11"/></svg>`, description: '开发者速查表：HTTP 状态码、MIME 类型等，支持搜索与一键复制', keywords: ['速查表', 'cheatsheet', 'http状态码', 'mime', '参考', '查表'], category: 'dev' },
  ...
  { id: 'slide', name: '幻灯片', icon: '🖼', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="14" rx="2"/><polyline points="8 10 12 14 16 10"/><line x1="12" y1="14" x2="12" y2="20"/><line x1="8" y1="20" x2="16" y2="20"/></svg>`, description: 'Markdown 幻灯片：用 --- 分割页面，键盘翻页，全屏预览，导出单文件离线 HTML', keywords: ['幻灯片', 'slide', 'markdown', 'ppt', 'presentation', '演示', '全屏', '导出html'], category: 'utility' },
  { id: 'mindmap', name: '思维导图', icon: '🧠', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="4" cy="12" r="2"/><circle cx="20" cy="6" r="2"/><circle cx="20" cy="12" r="2"/><circle cx="20" cy="18" r="2"/><line x1="6" y1="12" x2="14" y2="12"/><line x1="14" y1="12" x2="18" y2="6"/><line x1="14" y1="12" x2="18" y2="12"/><line x1="14" y1="12" x2="18" y2="18"/><line x1="14" y1="12" x2="14" y2="12"/></svg>`, description: 'Markdown 自动生成思维导图：拖拽缩放、多主题、导出 PNG/SVG', keywords: ['思维导图', 'mindmap', '脑图', 'markmap', 'markdown', '导出', 'png', 'svg'], category: 'utility' },
  { id: 'mindmapEditor', name: '脑图画布', icon: '🎨', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="2"/><circle cx="5" cy="5" r="1.5"/><circle cx="19" cy="5" r="1.5"/><circle cx="5" cy="19" r="1.5"/><circle cx="19" cy="19" r="1.5"/><line x1="6.5" y1="6.5" x2="10.5" y2="10.5"/><line x1="17.5" y1="6.5" x2="13.5" y2="10.5"/><line x1="6.5" y1="17.5" x2="10.5" y2="13.5"/><line x1="17.5" y1="17.5" x2="13.5" y2="13.5"/></svg>`, description: '自由创建/编辑思维导图：4 种布局、多主题、节点拖拽编辑、导入导出 JSON/Markdown/PNG/SVG', keywords: ['脑图', '画布', 'mindmap', '编辑', '思维导图', 'mind-elixir', '布局', '导出'], category: 'utility' },
  ...
  { id: 'contextMenu', name: '右键菜单', icon: '🖱', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8h18v12a1 1 0 01-1 1H4a1 1 0 01-1-1V8z"/><path d="M3 8l3-5h12l3 5"/><line x1="7" y1="13" x2="13" y2="13"/><line x1="7" y1="17" x2="11" y2="17"/></svg>`, description: '管理 Windows 右键菜单：文件/文件夹/桌面右键的自定义项增删，自动备份恢复', keywords: ['右键菜单', 'context menu', '注册表', 'shell', '新建', '发送到', '菜单管理'], category: 'system' },
  ...
  { id: 'logViewer', name: '日志查看器', icon: '📜', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="14" y2="17"/></svg>`, description: '实时查看日志文件，支持过滤、高亮、自动滚动，类似 tail -f', keywords: ['日志', 'log', 'tail', '查看', '实时', '监控', '日志查看'], category: 'system' },
  ...
  { id: 'entityGen', name: '代码实体生成', icon: 'Ent', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><path d="M10 6.5h5a2 2 0 012 2v2"/><path d="M14 17.5h-5a2 2 0 01-2-2v-2"/></svg>`, description: '根据 JSON 或 SQL DDL 生成 TypeScript/Java/Go/Rust/Python/C# 实体类，六语言自由勾选', keywords: ['实体', '代码生成', 'entity', 'model', 'pojo', 'json', 'sql', 'ddl', 'typescript', 'java', 'go', 'rust', 'python', 'csharp', 'pojo生成'], category: 'dev' },
  { id: 'folderDiff', name: '目录对比', icon: '📂', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11 19H4a2 2 0 01-2-2V5a2 2 0 012-2h4l2 3h3a2 2 0 012 2v1"/><path d="M13 19h7a2 2 0 002-2v-6a2 2 0 00-2-2h-4l-2-3h-2a2 2 0 00-2 2v9a2 2 0 002 2z"/><path d="M9 13h6"/></svg>`, description: '递归对比两个文件夹的文件差异（新增/删除/修改/大小变化），支持忽略规则，只读查看', keywords: ['目录对比', '文件夹对比', 'folder', 'diff', '目录', '文件夹', '差异', '比较', '同步检查'], category: 'utility' },
  { id: 'totp', name: 'TOTP 验证器', icon: '🔐', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 8v4l2.5 1.5"/></svg>`, description: 'TOTP 二次验证码生成器，支持扫码导入 otpauth 二维码、密钥管理、实时倒计时', keywords: ['totp', '二次验证', '两步验证', '2fa', '验证码', 'otp', 'authenticator', '动态口令', '谷歌验证器', 'otpauth', 'mfa'], category: 'security' },
  { id: 'hexViewer', name: '十六进制查看器', icon: '0x', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><rect x="8" y="12" width="3" height="3" rx="0.5"/><rect x="13" y="12" width="3" height="3" rx="0.5"/><rect x="8" y="16" width="3" height="3" rx="0.5"/><rect x="13" y="16" width="3" height="3" rx="0.5"/></svg>`, description: '以十六进制方式查看二进制文件，分页浏览、ASCII 预览、字节偏移定位', keywords: ['十六进制', 'hex', '二进制', '查看器', 'hex viewer', '字节', 'ascii', 'dump', 'hex dump'], category: 'dev' },
  { id: 'fileEncoding', name: '文件编码转换', icon: 'EC', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 15l-2-2 2-2"/><path d="M15 11l2 2-2 2"/></svg>`, description: '单文件/批量文件编码转换，支持 UTF-8/GBK/GB2312/ISO-8859-1，自动检测源编码', keywords: ['编码转换', '文件编码', 'utf8', 'gbk', 'gb2312', '转码', 'encoding', '字符集', 'charset'], category: 'utility' },
  { id: 'emojiPanel', name: '表情符号', icon: '😀', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>`, description: '表情符号选择面板，分类浏览、搜索、一键复制，最近使用记录', keywords: ['表情', 'emoji', '符号', 'emoticon', '笑脸', '表情面板', '复制'], category: 'utility' },
  { id: 'fontPreview', name: '字体预览', icon: 'Aa', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7V4h16v3"/><path d="M9 20h6"/><path d="M12 4v16"/><path d="M16 16l-2-4-2 4"/><path d="M14 13h-4"/></svg>`, description: '预览系统已安装字体，自定义文本/字号/粗细，搜索过滤，点击复制字体名', keywords: ['字体', 'font', '预览', '字体预览', '字重', '字号', '字体列表', 'typography'], category: 'utility' },
  { id: 'asciiArt', name: 'ASCII艺术', icon: 'A#', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"/><path d="M8 8h8M8 12h8M8 16h5"/></svg>`, description: '文本转字符画、图片转 ASCII 艺术，自定义字符集/宽度/反转', keywords: ['ascii', '字符画', '艺术', '文本转ascii', '图片转ascii', '字符艺术', 'ascii art'], category: 'utility' },
]
